      ...
      <div className="max-w-3xl mx-auto px-8 py-10">
        ...
        {all.length === 0 ? (
          <div className="flex flex-col items-center py-20 text-center">
            ...
            <p className="text-muted-foreground text-sm">Задачи по этой теме пока не добавлены</p>
            <p className="text-muted-foreground/40 text-xs mt-2 font-mono">Запусти scripts/fetch_codeforces.js чтобы загрузить задачи</p>
          </div>
        ) : (
