        ...
        <section className="relative pt-40 pb-32 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
            <motion.div
              ...
              className="inline-flex items-center rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 text-sm font-medium text-primary mb-10 backdrop-blur-md"
            >
              <span className="w-2 h-2 rounded-full bg-primary mr-2.5 animate-pulse" />
              Version 2.0 — Now live for advanced engineers
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tighter font-sans leading-[1.08] mb-8 bg-gradient-to-br from-white via-white to-white/40 bg-clip-text text-transparent"
            >
            ...
            <motion.p
              ...
              className="max-w-2xl mx-auto text-lg md:text-xl text-white/50 leading-relaxed font-medium mb-12"
            >
              An elite ecosystem combining Socratic AI tutoring, Piston-powered live execution, and structured mathematical logic to forge top-tier engineers.
            </motion.p>
